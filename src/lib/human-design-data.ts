...
export const HD_CHANNELS: HdChannel[] = [
  ...
  { id: '44-26-alt', gates: [28, 38], fromCenter: 'spleen', toCenter: 'root', vn: 'Đấu Tranh', en: 'Struggle' },
  ...
  { id: '48-16-alt', gates: [57, 20], fromCenter: 'spleen', toCenter: 'throat', vn: 'Sóng Não', en: 'Brainwave' },
  { id: '6-59', gates: [6, 59], fromCenter: 'solar-plexus', toCenter: 'sacral', vn: 'Thân Mật', en: 'Intimacy' },
  { id: '37-40-alt', gates: [49, 19], fromCenter: 'solar-plexus', toCenter: 'root', vn: 'Tổng Hợp', en: 'Synthesis' },
  ...
  { id: '36-35-alt', gates: [47, 64], fromCenter: 'ajna', toCenter: 'head', vn: 'Trừu Tượng', en: 'Abstraction' },
